...
Page role: The page shows all features on one page in five groupings
...
- **HubSpot** — Push qualified leads to your HubSpot CRM.
- **Clay** — Export leads to Clay for further enrichment.
- **CSV and Excel** — Download lead lists as a spreadsheet.
- **Webhooks** — Trigger external systems when a lead moves.
- **API** — Build your own integrations on top of teamfluence.
